...
AVRDUDE_PORT = usb    # Arduino with ATmega8 as USB serial converter
...
GENDEPFLAGS = -MMD -MP -MF $(DEPDIR)/$(patsubst $(OBJDIR)/%.o,%.d,$(@))
...
build: $(OBJ) elf hex bin eep lss sym
#build: lib

$(OBJ): | $(OBJDIRS) $(LSTDIRS) $(DEPDIRS)
